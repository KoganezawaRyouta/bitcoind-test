...
// CustomerServiceClient is the client API for CustomerService server.
//
...
// CustomerServiceServer is the server API for CustomerService server.
...
func init() { proto.RegisterFile("app.proto", fileDescriptor_stream_f0f18bd38bfc6f44) }
